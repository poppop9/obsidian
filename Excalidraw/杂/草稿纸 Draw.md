...
```json
{
	...
	"elements": [
		...
		},
		{
			...
			"y": -316.40145169800843,
			"strokeColor": "#1e1e1e",
			"backgroundColor": "transparent",
			"width": 226.53918753732705,
			"height": 7.332379697346994,
			"seed": 709204375,
			"groupIds": [
				"qx4T7IaayHInFrYxXCYYg"
			],
	...
	"appState": {
		...
		"scrollX": 632.9899458562722,
		"scrollY": 501.4341221224645,
		"zoom": {
			"value": 2
		},
